...
export const orders: Order[] = [
  {
    ...
    tailorLocation: "Bangkok, Thailand",
    customerId: "cust-001",
    customerName: "Jane Davidson",
    garmentType: "2-Piece Suit",
    description: "Classic navy 2-piece suit with slim cut, notched lapel. Premium Thai-imported wool-blend fabric.",
  ...
  },
  {
    ...
    tailorLocation: "Hanoi, Vietnam",
    customerId: "cust-001",
    customerName: "Jane Davidson",
    garmentType: "Silk Áo Dài",
    description: "Traditional Vietnamese Áo Dài in ivory silk with hand-embroidered floral motifs along the collar and cuffs.",
    ...
    milestones: [
      ...
      { label: "In Production", description: "Tailor cut and hand-embroidered your Áo Dài", date: "5 May 2026", status: "completed" },
  ...
  },
  {
    ...
    tailorLocation: "Dhaka, Bangladesh",
    customerId: "cust-002",
    customerName: "Kofi Asante",
    garmentType: "Embroidered Kurta Set",
    description: "Block-print cotton kurta with matching trousers. Deep indigo base with hand-block-printed geometric pattern.",
    ...
    milestones: [
      ...
      { label: "In Production", description: "Tailor cut and block-printed your kurta set", date: "25 Apr 2026", status: "completed" },
