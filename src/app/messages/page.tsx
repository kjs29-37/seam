...
const conversations: Conversation[] = [
  {
    ...
    tailorName: "Bangkok Classic Tailors",
    orderId: "ORD-001",
  ...
  },
  {
    id: "conv-002",
    tailorId: "hanoi-silk",
    tailorName: "Hanoi Silk Atelier",
    orderId: "ORD-002",
    garment: "Silk Áo Dài",
    lastMessage: "Your Áo Dài has been dispatched via DHL. Tracking: DHL-7734920011",
    lastTime: "14 May",
    unread: 0,
    messages: [
      { id: "m1", from: "customer", body: "Hello! I'd love a custom Áo Dài in ivory silk for a special occasion. Do you source your own silk?", time: "2 May, 10:00" },
      { id: "m2", from: "tailor", body: "Yes, we source directly from Hà Đông, the traditional silk weaving district near Hanoi. Each piece is woven by hand. What occasion is this for?", time: "2 May, 12:00" },
      { id: "m3", from: "customer", body: "It's for a wedding — I'm a guest. I'd like something elegant but not too formal.", time: "2 May, 13:30" },
      { id: "m4", from: "tailor", body: "Perfect — I have a beautiful ivory Áo Dài design in mind with delicate lotus embroidery. I'll send a quote shortly. Expected production: 10 days.", time: "2 May, 14:15" },
      { id: "m5", from: "tailor", body: "Your Áo Dài has been dispatched via DHL. Tracking: DHL-7734920011", time: "14 May, 08:00" },
    ],
  },
  {
    id: "conv-003",
    tailorId: "dhaka-threads",
    tailorName: "Dhaka Thread Co.",
    garment: "Embroidered Kurta Set",
    lastMessage: "Could you share some reference images for the embroidery pattern you have in mind?",
    lastTime: "16 May",
    unread: 2,
    messages: [
      { id: "m1", from: "customer", body: "Hi! I'm interested in a bespoke block-print kurta set in indigo cotton.", time: "15 May, 16:00" },
      { id: "m2", from: "tailor", body: "Wonderful choice! Indigo block-print is one of our specialities. Could you share some reference images for the embroidery pattern you have in mind?", time: "16 May, 09:30", read: false },
      { id: "m3", from: "tailor", body: "Also — do you prefer the traditional straight-cut kurta or a more contemporary fit? And are you including matching trousers?", time: "16 May, 09:31", read: false },
    ],
  },
];
